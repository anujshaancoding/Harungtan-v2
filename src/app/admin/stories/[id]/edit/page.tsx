...
import { ArrowLeft, Save, Trash2, Image, Tags, Globe, Loader2 } from 'lucide-react'
  ...
  const onSubmit = async (data: StoryFormData) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(json.error || 'Failed to update story')
      }
    ...
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-[var(--foreground)]">Edit Story</h1>
            <p className="mt-1 text-sm text-[var(--muted-foreground)]">
              Update your blog post or brand story.
            </p>
          </div>
        </div>
        <Button
